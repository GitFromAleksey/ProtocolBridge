...
static void ConvertQuery_3230(uint32_t ble_cmd_id, uint8_t *data)
{
	...
	uart_query->u8_service_bit_field.ParingState = 0; // TODO нужно решить каким задавать этот параметр
...
uint32_t UART_GetData (uint8_t *data) // return ble_cmd_id
{
	...
	// из этих структур нужно вз€ть данные, адаптировать их дл€ BLE и отправить
//	ResponseData_3231;
//	ResponseData_3331;
//	ResponseData_3530;
//	ResponseData_3531;
